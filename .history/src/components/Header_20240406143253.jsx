...
function Header() {
  return (
    <Navbar fluid rounded>
      <Navbar.Brand href="/">
        <img src="https://www.zarla.com/website-builder/api/logo/41622f41157f9d9eae341e4da3002c75c0f13575b5f7a241e775529d56c8df0a" className="mr-3 h-8 sm:h-9" alt="AAcomputing Logo" />
