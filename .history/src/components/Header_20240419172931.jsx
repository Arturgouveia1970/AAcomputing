    ...
    <Navbar fluid rounded className="fixed w-full shadow rounded-none bg-blue text-gold bg-opacity-100 lg:p-5">
        <Navbar.Brand href="/">
          <img 
            ...
            className="text-sm mr-0 w-20 h-20 ml-4 sm:w-20 sm:h-20 lg:text-lg md:ml-20 md:w-32 md:h-auto ml:ml-30"
        ...
        <Navbar.Toggle />
        <Navbar.Collapse className="mr-8 md:text-2xl md:mr-20">
