...
export default function Hero() {
  return (
    <div className="p-5 flex flex-col items-center mx-auto justify-center bg-opacity-100 shadow font-['Nunito']">
      <h1 className="font-semibold text-2xl mt-20">Serviços especializados de desenvolvimento de software em Angola</h1>
      <br />
      <div className="p-0 bg-white rounded-lg shadow-lg opacity-90">
        <p>
