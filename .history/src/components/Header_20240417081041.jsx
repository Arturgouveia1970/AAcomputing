...
function Header() {
  return (
    <Navbar fluid rounded className="fixed w-full shadow rounded-none bg-blue text-gold">
      <Navbar.Brand href="/">
        <img 
          ...
          className="mr-5 w-50 h-20 ml-8 sm:w-20 sm:h-20"
      ...
      <Navbar.Collapse className="mr-8">
        ...
        <Link to="portfolio" smooth={true} duration={800} className="scroll-smooth cursor-pointer"></Link> <Navbar.Link href="/portfolio">Portfolio</Navbar.Link>
