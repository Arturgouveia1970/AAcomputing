...
export default function Hero() {
  return (
    <div className="p-1 flex flex-col items-center mx-auto justify-center bg-opacity-100 shadow font-['Nunito']">
      <h1 className="mt-20 pt-15 w-full text-center text-lg font-semibold">Serviços especializados de desenvolvimento de software em Angola</h1>
      <br />
      <div className="p-5 bg-white rounded-lg shadow-lg opacity-90">
        <p>
