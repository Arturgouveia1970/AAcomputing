...
function Header() {
  return (
    <Navbar fluid rounded className="font-mont fixed w-full shadow rounded-none bg-blue text-gold lg:p-5">
        ...
        <Navbar.Toggle />
        <Navbar.Collapse className="font-mont text-gray100 mr-8 md:mr-20">
          <Navbar.Link href="/" className="lg:text-lg">Home</Navbar.Link>
          <Link to="about" smooth={true} duration={800} className="scroll-smooth cursor-pointer"><Navbar.Link className="font-mont lg:text-lg font-semibold !important">Sobre</Navbar.Link></Link>
