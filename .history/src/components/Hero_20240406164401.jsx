...
export default function Hero() {
  return (
    <div className=" flex flex-col items-center mx-auto justify-center bg-gray100 shadow-black">
      <h1 className="font-semibold pt-20 pl-20 text-2xl">Serviços especializados de desenvolvimento de software em<br /> Angola</h1>
      <br />
      <div className="pl-24 pr-24 pb-20">
        <p>
