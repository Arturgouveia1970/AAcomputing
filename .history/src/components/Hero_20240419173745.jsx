...
export default function Hero() {
  return (
    <div className="p-1 flex flex-col items-center mx-auto justify-center bg-opacity-0 font-['Nunito'] md:mx-20">
      <h1 className="mt-20 pt-20 w-full text-center text-lg font-semibold md:text-2xl md:mt-30 lg:text-3xl">Serviços especializados de desenvolvimento de software em Angola</h1>
      <br />
