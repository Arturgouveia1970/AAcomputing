...
export default function Hero() {
  return (
    <div className="p-20 flex flex-col items-center mx-auto pt-4 justify-center bg-opacity-100 shadow font-['Nunito']">
      <h1 className="font-semibold text-2xl">Serviços especializados de desenvolvimento de software em Angola</h1>
      <br />
      <div className="p-10 bg-white rounded-lg shadow-lg">
        <p>
          <b></b>AAcomputing é uma empresa especializada no desenvolvimento de software localizada no bairro da Maianga, em Luanda, que oferece
