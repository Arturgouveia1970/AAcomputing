  ...
  return (
    <Navbar fluid rounded className="fixed w-full shadow rounded-none bg-blue text-gold bg-opacity-100 lg:p-5">
      <Navbar.Brand href="/">
        ...
        />
        <span className="text-xl self-center whitespace-nowrap font-semibold dark:text-white font-['Nunito'] md:text-2xl">AAcomputing</span>
      </Navbar.Brand>
      <Navbar.Toggle />
      <Navbar.Collapse className="mr-8 md:text-xl">
