    ...
    <Navbar fluid rounded className="fixed w-full shadow rounded-none bg-blue text-gold bg-opacity-100 lg:p-5">
        <Navbar.Brand href="/">
          <img 
            ...
            className="text-sm mr-0 w-20 h-20 ml-4 sm:w-20 sm:h-20 lg:text-lg md:ml-20"
        ...
        <Navbar.Collapse className="mr-8 md:text-2xl md:ml-20">
          ...
          <Link to="portfolio" smooth={true} duration={800} className="scroll-smooth cursor-pointer"><Navbar.Link href="/portfolio">Portofolio</Navbar.Link></Link> 
