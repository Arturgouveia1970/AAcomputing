...
export default function Hero() {
  return (
    <div className="p-20 flex flex-col items-center mx-auto justify-center bg-opacity-100 shadow font-['Nunito']">
      <h1 className="font-semibold text-2xl mt-10">Serviços especializados de desenvolvimento de software em Angola</h1>
      <br />
      ...
      <div className="flex flex-col mt-10">
        <p className="p-6 items-center font-semibold justify-center mx-auto border rounded-full bg-blue text-white">Entre em contacto conosco</p>
