  ...
  return (
    <Navbar fluid rounded className="fixed w-full shadow rounded-none bg-blue text-gold bg-opacity-100 lg:p-5">
        ...
        <Navbar.Collapse className="mr-8 md:mr-20">
          ...
          <Link to="portfolio" smooth={true} duration={800} className="scroll-smooth cursor-pointer"><Navbar.Link className="lg:text-lg" href="/portfolio">Portofólio</Navbar.Link></Link> 
