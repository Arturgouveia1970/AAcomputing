...
export default function Hero() {
  return (
    <div className="p-2 flex flex-col items-center mx-auto justify-center bg-opacity-0 font-['Nunito'] md:mx-20 md:p-10">
      <h1 className="mt-20 pt-20 w-full text-center text-lg font-semibold md:text-2xl md:pt-30 lg:text-3xl">Serviços especializados de desenvolvimento de software em Angola</h1>
      <br />
      <div className="p-5 rounded-lg opacity-100 md:text-lg">
        <p>
          <b>AAcomputing</b> é uma empresa especializada no desenvolvimento de software 
          localizada no bairro da Maianga, em Luanda, que oferece
