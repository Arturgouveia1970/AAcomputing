...
export default function Hero() {
  return (
    <div className="p-1 flex flex-col items-center mx-auto justify-center bg-opacity-0 shadow font-['Nunito']">
      ...
      <br />
      <div className="p-5 bg-white rounded-lg shadow-lg opacity-20">
        <p>
