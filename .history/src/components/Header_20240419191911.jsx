...
function Header() {
  return (
    <Navbar fluid rounded className="font-mont fixed w-full shadow rounded-none bg-blue text-gold bg-opacity-50 lg:p-5">
        <Navbar.Brand href="/">
          <img 
          ...
          />
          <span className="text-xl self-center whitespace-nowrap font-semibold dark:text-white md:text-3xl">AAcomputing</span>
        </Navbar.Brand>
        <Navbar.Toggle />
        <Navbar.Collapse className="font-mont text-white mr-8 md:mr-20">
          <Navbar.Link href="/" className="lg:text-lg">Home</Navbar.Link>
          <Link to="about" smooth={true} duration={800} className="scroll-smooth cursor-pointer text-white"><Navbar.Link className="font-mont lg:text-lg font-semibold !important">Sobre</Navbar.Link></Link>
