    ...
    <Navbar fluid rounded className="fixed w-full shadow rounded-none bg-blue text-gold">
      <Navbar.Brand href="/">
        <img 
          ...
          className="text-sm mr-0 w-50 h-20 ml-8 sm:w-20 sm:h-20"
          alt="AAcomputing Logo" 
        />
        <span className="text-sm self-center whitespace-nowrap font-semibold dark:text-white font-['Nunito']">AAcomputing</span>
      </Navbar.Brand>
      <Navbar.Toggle />
