  ...
  return (
    <Navbar fluid rounded className="font-mont fixed w-full shadow rounded-none bg-blue text-gold lg:p-5">
        ...
        <Navbar.Collapse className="font-mont text-white mr-8 md:mr-20">
          ...
          <Link to="about" smooth={true} duration={800} className="scroll-smooth cursor-pointer text"><Navbar.Link className="font-mont lg:text-lg font-semibold !important">Sobre</Navbar.Link></Link>
