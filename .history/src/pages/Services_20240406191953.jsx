...
function Services() {
  return (
    <div className="flex flex-col p20 bg-black text-white font-['Nunito']">
      <div className="flex flex-col p-20 items-center text-lg font-semibold">
        <h1>Explore nossos serviços de desenvolvimento de software</h1>
      </div>
      <div className="flex items-center p- justify-center gap-20">
        <ul>
          <li>Desenvolvimento de sites</li>
          <li>Desenvolvimento de aplicativos móveis</li>
          <li>Soluções de comércio eletrônico</li>
