  ...
  return (
    <div className="flex flex-col gap-4 items-center mt-10">
      <div className="flex flex-col">
        ...
        <div className='mx-auto p-6 flex font-semibold text-2xl items-center justify-center border rounded-full bg-blue text-white'>
          <span className="mr-2 text-gold"><BsTelephoneFill /></span>
