  ...
  return (
    <Element name="services" id="servicos">
      <div className="w-full text-lg font-semibold p-1 bg-black text-white font-['Nunito']">
        <div className="mt-10 mb- text-xl font-semibold text-center">
        ...
        <div className="p-0 text-sm">
          <ul className="list-disc list-inside text-white">
            ...
            <li className="p-2 ml-4">Desenvolvimento de aplicativos móveis</li>
            <li className="p-2 ml-4">Soluções de comércio eletrônico</li>
            <li className="p-2 ml-4">Desenvolvimento de software personalizado</li>
