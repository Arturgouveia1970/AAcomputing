...
function About() {
  return (
    <Element name="about" className="w-full flex flex-col p-2 font-['Nunito'] scroll-smooth bg-opacity-100">
      <h1 className="w-full text-center text-sm font-semibold">Sobre AAcomputing</h1>
