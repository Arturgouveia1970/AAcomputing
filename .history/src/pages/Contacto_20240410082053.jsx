...
function Contacto() {
  ...
  return (
    <div className="flex flex-col gap-4 items-center">
      ...
      <form ref={form} id='contact' onSubmit={sendEmail} className="flex max-w-xl flex-col gap-4 mt-3">
      <div className="max-w-xl">
        <div className="mb-2 ">
          <Label htmlFor="name" value="o seu nome" />
        </div>
        <TextInput className="max-w-xl" type="text" name="contact_number" value="697483" id="nome1" placeholder="o seu nome" required />
      </div>
      ...
      <div className="block">
        ...
        <TextInput type="submit" value="Send" id="large" className="w-full h-32" />
