  ...
  return (
    <div className="flex flex-col gap-4 items-center p-20">
      ...
      <div className="w-full">
        ...
        <TextInput className="w-full" id="nome1" type="name" placeholder="o seu nome" required />
      </div>
      <div className="w-full">
        <div className="mb-2 block">
          <Label htmlFor="email1" value="o seu email" />
        </div>
        <TextInput id="email1" type="email" placeholder="name@flowbite.com" required className="w-full h-16" />
      </div>      
