  ...
  return (
    <Element name="services" id="servicos">
      <div className="w-full text-center text-lg font-semibold flex flex-col p-1 bg-black text-white font-['Nunito']">
        <div className="mt-10 mb-10 flex flex-col items-center text-xl font-semibold">
          <h1>Explore nossos serviços de desenvolvimento de software</h1>
        </div>
        <div className="flex flex-col p-0 gap-5 text-sm justify-items-stretch">
          <ul className="list-disc list-inside text-white items-stretch">
