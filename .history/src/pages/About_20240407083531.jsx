<Link to="about" smooth={true} duration={500} className="scroll-smooth">About</Link>

function About() {
  return (
    <Element name="about" className="flex flex-col bg-gray200 p-20 font-['Nunito'] scroll-smooth">
