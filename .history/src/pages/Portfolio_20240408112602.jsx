...
function Portfolio() {
  return (
    <div  className="flex flex-col bg-opacity-100 p-20 font-['Nunito']">
      <h1 className="text-center text-xl font-bold leading-4 pb-2">Explore nosso portfólio de projetos de desenvolvimento web</h1>
      <div className="p-10 leading-7 bg-white">
        <p>
