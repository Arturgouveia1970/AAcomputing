      ...
      <div className="w-full text-lg font-semibold p-1 bg-black text-white font-['Nunito']">
        ...
        <div className="pb-4 text-sm">
          <ul className="list-disc list-inside text-white">
            <li className="p-2 ml-4 whitespace-nowrap">Desenvolvimento de sites</li>
            <li className="p-2 ml-4 whitespace-nowrap">Desenvolvimento de aplicativos móveis</li>
            <li className="p-2 ml-4 whitespace-nowraps">Soluções de comércio eletrônico</li>
            <li className="p-2 ml-4 whitespace-nowrap">Desenvolvimento de software personalizado</li>
            <li className="p-2 ml-4 whitespace-nowrap">Hospedagem e Manutenção na Web</li>
          </ul>
          <ul className="list-disc list-inside text-white">
