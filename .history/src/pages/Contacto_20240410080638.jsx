...
function Contacto() {
  ...
  return (
    <div className="flex flex-col gap-4 items-center">
      ...
      <form ref={form} onSubmit={sendEmail} className="flex max-w-xl flex-col gap-4 mt-3">
      <div className="max-w-xl">
        <div className="mb-2 ">
          <Label htmlFor="name" value="o seu nome" />
        </div>
        <TextInput className="max-w-xl" type="hidden" name="contact_number" value="697483" id="nome1" placeholder="o seu nome" required />
      </div>
      <div className="w-full">
        <div className="mb-2 block">
          <Label htmlFor="email1" value="o seu email" />
        </div>
        <TextInput type="email" name="user_email" id="email1" type="email" placeholder="name@flowbite.com" required className="w-full" />
      </div>      
