...
function Portfolio() {
  return (
    <Element name="portfolio" className="items-center flex flex-col bg-opacity-90 p-1 pb-2 mb-10 font-['Nunito'] mt-10">
      <h1 className="text-center text-xl font-bold leading-4 mb-4 mx-auto">Explore nosso portfólio de projetos de desenvolvimento web</h1>
