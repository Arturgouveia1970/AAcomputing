    ...
    <Element name="services" id="servicos">
      <div className="w-full text-lg font-semibold p-1 bg-black text-white font-['Nunito']">
        ...
        <div className="pb-4 text-sm">
          ...
          <ul className="list-disc list-inside text-white">
            <li className="p-2 ml-8">Integração de API</li>
            <li className="p-2 ml-8">Design de UI/UX</li>
            <li className="p-2 ml-8">Sistemas de gerenciamento de conteúdo</li>
            <li className="p-2 ml-8">Serviços de marketing digital</li>
            <li className="p-2 ml-8">Consultoria e Suporte de TI</li>
          </ul>
        </div>
      </div>
      <div>
